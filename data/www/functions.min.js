function loadLocalFile(filename, filetype){
...
function setTime() {
  ...
  var syncTime = date.getTime();
  var datatosend = {};
  datatosend.command = "setTime";
  datatosend.syncTime = Math.round((syncTime - offset*60*1000)/1000 );
...
function checkInternet() {
  ...
  if(online){
    loadLocalFile("https://code.jquery.com/jquery-2.2.4.min.js", "js");
    loadLocalFile("https://code.jquery.com/ui/1.12.1/jquery-ui.min.js", "js");
    loadLocalFile("http://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css", "css");
  }
  else {
    loadLocalFile("jquery.min.js", "js");
    loadLocalFile("jquery-ui.min.js", "js");
    loadLocalFile("jquery-ui.css", "css");
  }
}
...
var Pins = {
    pinName: ["ALARM_ON", "HORN_ON", "REED_IN", "TEST"],
...
function startSocket() {
    ...
    ws.addEventListener('message', function(e) {
        ...
        try {
            obj = JSON.parse(msg);
            var dt = new Date(obj.ts * 1000 + 3600000 * -2);
    ...
    $(numbersBox).on('click', '.number', function(evt) {
        ...
        if (input.length >= 5) {
            ...
            jsonData = JSON.stringify({
                'command': "checkThisHash",
                'testHash': strHash.toUpperCase()
            });
            ws.send(jsonData);
            setTimeout(function() {
                if (!PinOK) {
                    ...
                    if (functionToDo == "sensorDisable")
                        var f = sensorToggleStatus(param1);
                    functionToDo = "";
                    param1 = "";
                }
            }, 200);
